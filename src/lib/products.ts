...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    categoryId: "betonarme-su-depolari",
    title: "Manevra Odası",
    shortTitle: "Manevra Odası",
    description: "Su depolarında vana, vantuz ve ölçüm ekipmanlarının yerleştirildiği prefabrik betonarme manevra odası.",
    image: "/images/products/betonarme-su-depolari.png",
    unit: "ADET",
    optionLabel: "Tip",
    options: [
      { id: "std", label: "Standart", length: "—", weight: "—" },
    ],
  },
  {
    id: "vantuz",
    ...
    title: "Vantuz",
    shortTitle: "Vantuz",
    description: "Su depolarında ve boru hatlarında hava tahliyesi için kullanılan prefabrik betonarme vantuz elemanı.",
    image: "/images/products/betonarme-su-depolari.png",
    unit: "ADET",
    optionLabel: "Tip",
    options: [
  ...
  },
  {
    ...
    title: "Kaptaj",
    shortTitle: "Kaptaj",
    description: "Kaynak ve yeraltı sularının toplanması için kullanılan prefabrik betonarme kaptaj elemanı.",
    image: "/images/products/betonarme-su-depolari.png",
    unit: "ADET",
    optionLabel: "Tip",
    options: [
  ...
  {
    id: "prefabrik-foseptik-depo",
    categoryId: "betonarme-su-depolari",
    title: "Prefabrik Foseptik Depo",
    shortTitle: "Foseptik Depo",
    description: "Kanalizasyon şebekesine bağlantısı olmayan yapılarda atık su depolamak amacıyla kullanılan prefabrik betonarme foseptik depolar.",
    image: "/images/products/betonarme-su-depolari.png",
    unit: "ADET",
    optionLabel: "Kapasite",
    options: [
      ...
      { id: "500kk",  label: "500 kk",  length: "—", weight: "—" },
      { id: "1000kk", label: "1000 kk", length: "—", weight: "—" },
    ],
  },
