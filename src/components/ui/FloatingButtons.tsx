...
export default function FloatingButtons() {
  ...
  return (
    <div className="fixed z-40 flex flex-col gap-2.5 lg:hidden print:hidden bottom-[max(1rem,env(safe-area-inset-bottom,0px))] right-[max(1rem,env(safe-area-inset-right,0px))] sm:bottom-6 sm:right-6">
